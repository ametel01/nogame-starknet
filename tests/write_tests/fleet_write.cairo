...
//     game.get_spendable_resources(1).print();
//     // start_prank(CheatTarget::One(contract_address), account);
//     // game.carrier_build(1);
//     // let mut fleet: Fleet = Default::default();
//     // fleet.carrier = 1;
...
//     // mission.time_arrival.print();
//     start_warp(CheatTarget::All, get_block_timestamp() + 3600);
// // warp_multiple(game.contract_address, get_contract_address(), mission.time_arrival + 1);
...
//     let defences_after = dsp.game.get_defences_levels(2);
//     let a_techs = dsp.game.get_techs_levels(1);
//     let b_techs = dsp.game.get_techs_levels(2);
