...
// start_cheat_block_timestamp, CheatTarget};
...
// };
// use super::utils::{E18, HOUR, Dispatchers, ACCOUNT1, ACCOUNT2, DEPLOYER, init_game, set_up,
...
//     start_cheat_caller_address_global(dsp, ACCOUNT1());
//     dsp.planet.generate_planet();

//     dsp.planet.energy_plant_upgrade(1);
//     dsp.planet.tritium_mine_upgrade(1);
//     start_cheat_block_timestamp(CheatTarget::All, HOUR * 2400000);
