...
//         assert(
//             cost.steel == 60.try_into().unwrap() & cost.quartz == 15.try_into().unwrap(),
//             'wrong formula'
//         );
//         let cost = Mines::steel_mine_cost(1);
//         assert(
//             cost.steel == 120.try_into().unwrap() & cost.quartz == 30.try_into().unwrap(),
//             'wrong formula'
//         );
//         let cost = Mines::steel_mine_cost(4);
//         assert(
//             cost.steel == 960.try_into().unwrap() & cost.quartz == 240.try_into().unwrap(),
//             'wrong formula'
//         );
//         let cost = Mines::steel_mine_cost(10);
//         assert(
//             cost.steel == 61440.try_into().unwrap() & cost.quartz == 15360.try_into().unwrap(),
//             'wrong formula'
//         );
//         let cost = Mines::steel_mine_cost(20);
//         assert(
//             cost.steel == 62914560.try_into().unwrap()
//                 & cost.quartz == 15728640.try_into().unwrap(),
//             'wrong formula'
//         );
//         // let cost = Mines::steel_mine_cost(30);
//         // assert(
//         //     cost.steel == 64424509440.try_into().unwrap()
//         //         & cost.quartz == 16106127360.try_into().unwrap(),
//         //     'wrong formula'
//         // );
//         let cost = Mines::steel_mine_cost(63);
//         // Max level before overflow.
//         // assert(
//         //     cost.steel == 553402322211286548480.try_into().unwrap()
//         //         & cost.quartz == 138350580552821637120.try_into().unwrap(),
//         //     'wrong formula'
//         // );
//     }
//     #[test]
